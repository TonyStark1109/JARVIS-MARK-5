...
def create_ppt_text(self, *args, **kwargs):  # pylint: disable=unused-argument
...
def create_ppt(self, *args, **kwargs):  # pylint: disable=unused-argument
...
def send_generated_image(self, *args, **kwargs):  # pylint: disable=unused-argument
    return send_file(os.path.join(PPT_DIR, path), as_attachment=True)

@app.route("/powerpoint")
def powerpoint(self, *args, **kwargs):  # pylint: disable=unused-argument
    return render_template("powerpoint.html", charset="utf-8")

@app.route("/")
def home(self, *args, **kwargs):  # pylint: disable=unused-argument
    return render_template("powerpoint.html", charset="utf-8")
@app.route("/get")
def get_bot_response(self, *args, **kwargs):  # pylint: disable=unused-argument
